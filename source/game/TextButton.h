...
public:
    TextButton(GameScene* parent, AABB box, std::string_view text): Object(parent, box+Vector2f(-box.scale.x/2, -box.scale.y/2), true, DRAW_LAYER_0), m_text(text), m_selected(false) {
